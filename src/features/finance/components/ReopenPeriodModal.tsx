...
export function ReopenPeriodModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-ink-navy/60 backdrop-blur-xs animate-in fade-in duration-200">
      ...
      >
        {/* Header */}
        <div className="flex items-center justify-between px-6 py-4 border-b border-hairline bg-amber-50/70">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          <div className="p-3.5 bg-cloud border border-hairline rounded-xl space-y-1.5 text-xs text-slate-gray">
            <div className="flex justify-between items-center">
              <span className="text-mist-gray">Kỳ chốt sổ:</span>
              <span className="font-bold text-ink-navy">{period.periodName}</span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-mist-gray">Khoảng thời gian:</span>
              <span className="font-medium text-slate-gray">
                {period.periodStart} &rarr; {period.periodEnd}
              </span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-mist-gray">Chốt bởi:</span>
              <span className="font-medium text-slate-gray">
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full px-3.5 py-2.5 text-sm bg-cloud border border-hairline rounded-xl focus:bg-white focus:outline-none focus:ring-2 focus:ring-amber-500/20 focus:border-amber-500 text-ink-navy placeholder:text-mist-gray"
            />
            {error && (
