    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-lg">
        ...
        <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-4 py-1">
          <div>
            <label className="block text-xs font-semibold text-slate-gray mb-1">
              Tên nhiệm kỳ <span className="text-rose-600">*</span>
            </label>
            <Input
              {...register('name')}
            ...
            <div>
              ...
              <Controller
                ...
                render={({ field }) => (
                  ...
                  >
                    <SelectTrigger className="w-full h-9 text-sm bg-white border-hairline">
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
          ...
          <div className="rounded-lg bg-cloud p-3 border border-hairline text-[11px] text-slate-gray space-y-1">
            <p className="font-semibold text-ink-navy">Lưu ý:</p>
          ...
          <DialogFooter className="pt-2">
            ...
            <Button type="submit" disabled={isLoading} className="bg-signal-blue hover:bg-[#005be0] text-white">
