    ...
    >
      ...
      <div className="rounded-xl border border-hairline bg-white p-4 shadow-xs">
        ...
        <div className="mt-2 flex items-baseline gap-2">
          ...
          <span className="text-xs text-mist-gray font-medium">periods</span>
        </div>
        <div className="mt-2 flex items-center gap-2 text-[11px] text-mist-gray flex-wrap">
          ...
          <span>•</span>
          <span className="text-slate-gray font-medium">{completedCount} closed</span>
        </div>
      </div>
      ...
      <div className="rounded-xl border border-hairline bg-white p-4 shadow-xs">
        ...
        <div className="mt-2 flex items-baseline gap-2">
          ...
          <span className="text-xs text-mist-gray font-medium">assignments</span>
        </div>
        <div className="mt-2 flex items-center gap-1 text-[11px] text-mist-gray">
          <span className="text-signal-blue font-semibold">{totalActivitiesCount} activities</span>
      ...
      <div className="rounded-xl border border-hairline bg-white p-4 shadow-xs">
        ...
        <div className="mt-2 flex items-baseline gap-2">
          ...
          <span className="text-xs text-mist-gray font-medium">snapshots</span>
        </div>
