  ...
  return (
    <div id="settings-roles-tab" className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs text-mist-gray font-mono">PostgreSQL Row-Level Security</span>
            </div>
          ...
          <div className="flex items-center gap-2.5 flex-wrap shrink-0">
            {canManage && (
              <Button
                ...
                className="text-xs h-8 bg-signal-blue hover:bg-[#005be0] text-white cursor-pointer shadow-xs font-medium gap-1.5"
              >
        ...
        <CardContent className="pt-5">
          {isLoading ? (
            ...
            <div className="py-8 text-center text-mist-gray text-xs">
              ...
              <p className="font-medium text-ink-navy">Chưa có thành viên Ban Chấp Hành</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              {boardMembers.map((membership) => {
                ...
                return (
                  <div
                    key={membership.id}
                    className="p-3 rounded-xl border border-hairline bg-cloud/50 hover:bg-cloud transition-colors flex items-center justify-between gap-3"
                  >
                    <div className="flex items-center gap-3 min-w-0">
                      <div className="h-10 w-10 rounded-xl bg-[#e6f0ff] border border-[#d4e4fa] flex items-center justify-center font-bold text-xs text-signal-blue shrink-0 shadow-xs">
                      ...
                      <div className="min-w-0">
                        ...
                        <p className="text-[11px] text-mist-gray font-mono truncate">
      ...
      <Card className="border-hairline shadow-xs bg-white">
        <CardHeader className="pb-4 border-b border-hairline">
          <CardTitle className="text-sm sm:text-base font-bold text-ink-navy flex items-center gap-2">
            <KeyRound className="h-4 w-4 text-signal-blue" />
        ...
        <CardContent className="p-0">
          <div className="divide-y divide-hairline">
            {roleDefinitionsList.map((roleDef) => {
              ...
              return (
                <div key={roleDef.key} className="p-4 flex flex-col sm:flex-row sm:items-center justify-between gap-3 hover:bg-cloud/50 transition-colors">
                  <div className="flex items-start gap-3 min-w-0">
                    ...
                    <div>
                      <div className="flex items-center gap-2">
                        <span className="text-xs font-bold text-ink-navy">{roleDef.label}</span>
                        <Badge variant="outline" className="text-[10px] font-mono py-0 px-1.5 text-mist-gray">
                  ...
                  <div className="shrink-0 flex items-center gap-3 self-end sm:self-center">
                    <span className="text-xs font-semibold text-slate-gray bg-pebble px-2.5 py-1 rounded-lg border border-hairline">
