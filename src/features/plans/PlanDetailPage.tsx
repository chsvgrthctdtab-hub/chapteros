...
export function PlanDetailPage() {
  ...
  return (
    <div id="plan-detail-page" className="p-4 sm:p-5 lg:p-6 max-w-7xl mx-auto space-y-3">
      ...
      <Card className="bg-white border border-slate-200 rounded-2xl overflow-hidden shadow-2xs">
        ...
        <div className="p-4 sm:p-5 space-y-3">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 pt-3 border-t border-slate-100">
            <div className="flex items-center gap-2 p-2.5 bg-purple-50/50 rounded-xl border border-purple-100/60">
              <div className="h-8 w-8 bg-purple-100 text-purple-700 rounded-lg flex items-center justify-center shrink-0">
                <Building2 className="h-4 w-4" />
              </div>
              <div className="min-w-0">
                <div className="text-[10px] font-medium text-purple-800 flex items-center gap-1">
                  <span>Chủ trì:</span>
            ...
            <div className="flex items-center gap-2 p-2.5 bg-slate-50 rounded-xl border border-slate-100">
              <div className="h-8 w-8 bg-blue-100/70 text-blue-700 rounded-lg flex items-center justify-center shrink-0">
                <Users className="h-4 w-4" />
              </div>
              <div className="min-w-0">
                <div className="text-[10px] font-medium text-slate-500">Đơn vị tham gia</div>
                <div className="text-xs font-bold text-slate-900 truncate">
            ...
            <div className="flex items-center gap-2 p-2.5 bg-slate-50 rounded-xl border border-slate-100">
              <div className="h-8 w-8 bg-emerald-100/70 text-emerald-700 rounded-lg flex items-center justify-center shrink-0">
                <Calendar className="h-4 w-4" />
              </div>
              <div className="min-w-0">
                <div className="text-[10px] font-medium text-slate-500">Thời gian triển khai</div>
                <div className="text-xs font-bold text-slate-900 truncate">
            ...
            <div className="flex items-center gap-2 p-2.5 bg-slate-50 rounded-xl border border-slate-100">
              <div className="h-8 w-8 bg-amber-100/70 text-amber-700 rounded-lg flex items-center justify-center shrink-0">
                <DollarSign className="h-4 w-4" />
              </div>
              <div className="min-w-0">
                <div className="text-[10px] font-medium text-slate-500">Quỹ chiến dịch</div>
      ...
      <div className="flex items-center gap-1 border-b border-slate-200 pb-0.5 overflow-x-auto">
        <button
