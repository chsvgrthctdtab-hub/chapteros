    ...
    <div id="plan-detail-page" className="w-full space-y-5">
      ...
      <Card className="bg-white border border-slate-200 rounded-2xl overflow-hidden shadow-2xs">
        ...
        <div className="p-5 sm:p-6 space-y-4">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 pt-4 border-t border-slate-100">
            <div className="flex items-center gap-3 p-3.5 bg-purple-50/50 rounded-xl border border-purple-100/60">
      ...
      <div className="flex items-center gap-2 border-b border-slate-200 pb-1 overflow-x-auto">
        <button
          ...
          className={`px-4 py-2 text-xs sm:text-sm font-bold rounded-xl flex items-center gap-2 transition-all whitespace-nowrap ${
