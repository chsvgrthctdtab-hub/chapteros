    ...
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          {/* Header Card */}
          <div className="bg-white rounded-2xl border border-hairline p-5 sm:p-6 space-y-4 shadow-xs">
            ...
            <div className="pt-2 space-y-3">
              ...
              {task.status === 'cancelled' ? (
                ...
                <div className="p-3 bg-cloud border border-hairline rounded-xl">
              ...
              {canUpdate && allowedTransitions.length > 0 && (
                <div className="p-3.5 bg-[#e6f0ff]/40 rounded-xl border border-[#d4e4fa] space-y-2">
                  <div className="flex items-center justify-between text-xs">
                    <span className="font-semibold text-ink-navy flex items-center gap-1.5">
                      <Shield className="w-3.5 h-3.5 text-signal-blue" />
                      <span>Thao tác chuyển trạng thái cho phép</span>
                    </span>
                  </div>
            ...
            <div className="pt-2">
              ...
              {task.description ? (
                <div className="text-xs text-ink-navy leading-relaxed whitespace-pre-wrap bg-cloud p-4 rounded-xl border border-hairline">
                  {task.description}
                </div>
              ) : (
                <p className="text-xs text-mist-gray italic">Chưa có mô tả cho nhiệm vụ này.</p>
              )}
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl border border-hairline p-5 sm:p-6 space-y-4 shadow-xs">
            <div className="flex items-center justify-between">
              <h3 className="text-xs font-semibold text-slate-gray uppercase tracking-wider flex items-center gap-1.5">
                    ...
                    <button
                      ...
                      className={cn(
                        ...
                        task.progress === val
                          ...
                          : 'bg-cloud hover:bg-pebble text-slate-gray hover:text-ink-navy border-hairline'
                      )}
                    >
                      {val}%
                    </button>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-2xl border border-hairline p-5 space-y-3.5 shadow-xs">
            ...
            <div className="p-3 rounded-xl bg-cloud border border-hairline space-y-1.5">
              <div className="flex items-center gap-2">
